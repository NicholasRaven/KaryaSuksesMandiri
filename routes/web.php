...
use Illuminate\Support\Facades\Auth;
    ...
    // Route::middleware(['AdminMiddleware', 'UserRole:Pimpinan'])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        //Redirect untuk /customer ke customers.index
        Route::get('/customer', function () {
                    return redirect()->route('customers.index');

    });

    //Resource route yang bisa diakses semua user
    ...
    Route::post('transactions/{transaction}/store-prices', [TransactionController::class, 'storeSupplierPrices'])->name('transactions.store_supplier_prices');
