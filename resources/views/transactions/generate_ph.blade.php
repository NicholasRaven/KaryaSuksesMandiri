<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg" style="height: 1123px; padding: 20px; display: flex; flex-direction: column; justify-content: space-between;">
...
gtd
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                @foreach ($transaction->details as $index => $detail)
                                    @php
                                        $hargaPerUnit = $detail->selectedSupplierPrice->price ?? 0;
                    ...
                    <!-- Cap Perusahaan -->
                    <div class="mb-6">
                        <label for="cap_perusahaan" class="block font-medium text-sm text-gray-700 dark:text-gray-300">
                            Cap Perusahaan:
                        </label>
                        <div class="flex justify-start mt-2">
                            <img src="{{ asset('image/Logo Perusahaan.png') }}" alt="Cap Perusahaan" class="w-24 h-24 object-contain border border-gray-300 dark:border-gray-700 rounded">
                        </div>
                    </div>
                </div>

                <!-- Footer buttons aligned at bottom -->
