                                        ...
                                        <td class="py-4 px-6 text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                @elseif ($transaction->process_status == 'Invoice Dibuat' && $transaction->payment_status == 'Belum Bayar')
                                                    ...
                                                    <form action="{{ route('transactions.update_payment_status', ['transaction' => $transaction->id, 'type' => 'payment']) }}" method="POST">
                                                        @csrf
                                                ...
                                                @elseif ($transaction->process_status == 'Invoice Dibuat' && $transaction->payment_status == 'Lunas')
                                                    ...
                                                    <form action="{{ route('transactions.update_payment_status', ['transaction' => $transaction->id, 'type' => 'process']) }}" method="POST">
                                                        @csrf
