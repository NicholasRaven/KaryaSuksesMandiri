                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('transactions.store_po_received', $transaction->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            @enderror
                            @if ($transaction->invoice && $transaction->invoice->po_file_path)
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">File PO sudah ada: <a href="{{ Storage::url($transaction->invoice->po_file_path) }}" target="_blank" class="text-blue-500 hover:underline">Lihat File</a></p>
                            @endif
                        </div>
