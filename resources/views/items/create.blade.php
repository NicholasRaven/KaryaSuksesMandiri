                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('items.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="unit_type" id="unit_type" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full @error('type') border-red-500 @enderror" required>
                                <!-- <option value="">Pilih Unit</option> -->
                                <option value="Pcs" {{ old('unit_type') == 'Pcs' ? 'selected' : '' }}>Pcs</option>
                                <option value="Set" {{ old('unit_type') == 'Set' ? 'selected' : '' }}>Set</option>
                                <option value="m" {{ old('unit_type') == 'm' ? 'selected' : '' }}>m</option>
                                ...
                                <option value="gr" {{ old('unit_type') == 'gr' ? 'selected' : '' }}>gr</option>
                                <option value="Box" {{ old('unit_type') == 'Box' ? 'selected' : '' }}>Box</option>
                                <option value="Kaleng" {{ old('unit_type') == 'Kaleng' ? 'selected' : '' }}>Kaleng</option>
                                <option value="Botol" {{ old('unit_type') == 'Botol' ? 'selected' : '' }}>Botol</option>
                                <option value="Paket" {{ old('unit_type') == 'Paket' ? 'selected' : '' }}>Paket</option>
                            </select>
                            @error('unit_type')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <select name="supplier_id" id="supplier_id" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full @error('supplier_id') border-red-500 @enderror" required>
